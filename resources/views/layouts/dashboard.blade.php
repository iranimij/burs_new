...
<head>
    ...
    <title>وبسایت بورس | @yield("title")</title>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview @if(strpos($current_url,"accounts") !== false) menu-open @endif">
                        <a href="#" class="nav-link @if(strpos($current_url,"accounts") !== false) active @endif ">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                اکانت ها
                    ...
                    <li class="nav-item has-treeview @if(strpos($current_url,"orders") !== false) menu-open @endif">
                        <a href="#" class="nav-link @if(strpos($current_url,"orders") !== false) active @endif ">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                سفارشات
                                <i class="right fas fa-angle-left"></i>
